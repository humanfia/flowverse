...
The coordinator plans once in base mode and arrives fresh for every audit in mission mode. Three
lanes run concurrently; each has actors A and B alternating in fresh sessions.
